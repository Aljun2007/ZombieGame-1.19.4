...
public class GameProperty {
    ...
    public static class ZombieProperty {
        ...
        public static double getZombieWalkSpeedPlus() {
            return 0.8d + 0.4d * GameProperty.TimeProperty.getGameStage();
        }

        public static double getZombieAttackValue() {
            return 1.5d + 1.5d * GameProperty.TimeProperty.getGameStage();

        }

        public static double getZombieArmor() {
            return 2d + 2d * GameProperty.TimeProperty.getGameStage();

        }

        public static double getZombieBreakSpeedBase() {
            return 1.0d + 1.5d * GameProperty.TimeProperty.getGameStage();
        }
        ...
        public static double getZombieSenseHeight() {
            return RandomUtils.nextBoolean(0.05d) ? 300d : 30d;
        }
    }
